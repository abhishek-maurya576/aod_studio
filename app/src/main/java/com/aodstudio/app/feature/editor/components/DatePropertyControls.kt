...
/**
 * Dedicated property controls for DATE elements:
 * Date format presets, text alignment, typography, and font size.
 */
@Composable
fun DatePropertyControls(
    element: AODElement,
    ...
    Column(
        ...
        Row(
            ...
            val formats = listOf("EEE • MMM dd", "EEEE, MMMM dd", "dd/MM/yyyy", "MMM dd, yyyy", "MON • AUG 10", "EEE, MMM dd")
            val currentFormat = element.properties[AODElement.PROP_FORMAT] ?: "EEE • MMM dd"
        ...
        // ─── 4. Font Size Slider ───────────────────────────────────────
        Text(
            text = "Date Font Size: ${element.style.fontSize.toInt()} sp",
